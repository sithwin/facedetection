...
export class FaceApiService {
  ...
  private baseUrl = 'https://acas-face-api.cognitiveservices.azure.com/face/v1.0';
  ...
  addPersonFace(personGroupId, personId, url) {
    ...
    ${personGroupId}/persons/${personId}/persistedfaces?userData=${url}`, { url: url}, httpOptions);
  }
  ...
  detect(url) {
    ...
    /detect?returnFaceLandmarks=false&returnFaceAttributes=age,gender,smile,glasses,emotion,facialHair`, { url: url }, httpOptions);
  }
...
const httpOptions = {
  headers: new HttpHeaders({
    ...
    'Ocp-Apim-Subscription-Key': '5487320ad34841b797dc11a9bf940d07'
  })
};
